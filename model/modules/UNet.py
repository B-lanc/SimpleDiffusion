...
class UNet(nn.Module):
    def __init__(self, in_channels, out_channels, emb_channels):
        ...
        self.up1 = UpConv(512, 256, self.emb_channels)
        self.attn3 = AttentionBlock(256)
        self.up2 = UpConv(256, 128, self.emb_channels)
        self.attn4 = AttentionBlock(128)
        self.up3 = UpConv(128, 64, self.emb_channels)
...
class MASKINGUNet(nn.Module):
    def __init__(self, in_channels, out_channels, emb_channels):
        ...
        self.up1 = MASKUpConv(512, 256, self.emb_channels)
        self.attn3 = AttentionBlock(256)
        self.up2 = MASKUpConv(256, 128, self.emb_channels)
        self.attn4 = AttentionBlock(128)
        self.up3 = MASKUpConv(128, 64, self.emb_channels)
        self.outconv = nn.Conv2d(64, out_channels, 1, 1, 0)
